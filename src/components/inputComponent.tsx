...
const styles = StyleSheet.create({
  label: { color: "#fff", marginBottom: 5, fontSize: 16, fontWeight: "500" },
  input: { backgroundColor: "white", width: 300, height: 40, padding: 4, borderWidth: 1, borderColor: "#6876A0", borderRadius: 8, marginBottom: 15 },
});